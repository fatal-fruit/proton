...
var (
	/*
		...
		so that other modules that want to create or claim capabilities afterwards in InitChainv
		can do so safely.
	*/
	...
	/*
		...
		validator fee pool, so as to keep the CanWithdrawInvariant invariant.
		...
		Modules: []*appv1alpha1.ModuleConfig{
			...
			},
			{
				...
				Config: appconfig.WrapAny(&authmodulev1.Module{
					...
					// Authority: "proton1cwwv22j5ca08ggdv9c2uky355k908694z577tv", // or a specific address
				}),
			},
			{
